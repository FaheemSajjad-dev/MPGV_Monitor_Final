...
describe('TimeWindowSlider – basic render', () => {
  ...
  it('shows the date-range text on screen', () => {
    renderSlider();
    // Text is like "Jun 2020 to <current month>" — use a specific selector to avoid matching the zoom indicator.
...
describe('TimeWindowSlider – year mode labels', () => {
  it('shows a label for each full year in the data window', () => {
    renderSlider();
    // Data starts Jun 2020; the stable full-year labels through 2025 must exist.
